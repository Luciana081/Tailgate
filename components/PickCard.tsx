...
export default function PickCard({ pick, onLike }: Props) {
  ...
  return (
    <View style={styles.card}>
          ...
          <View style={styles.nameRow}>
            ...
            {pick.isUserPick && (
              <View style={styles.userBadge}>
                <Text style={styles.userBadgeText}>YOUR PICK</Text>
              </View>
            )}
          </View>
      ...
      {(pick.oddsMarket || pick.oddsBookmaker) && (
        <Text style={styles.oddsMeta}>
          {[pick.oddsMarket, pick.oddsBookmaker].filter(Boolean).join(' • ')}
        </Text>
      )}
